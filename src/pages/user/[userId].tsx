...
} from "@backend/schemas/UserInfoUpdateSchema";
                    ...
                    <div className="md:w-1/4 w-3/4">
                      ...
                      >
                        ...
                        <div className="w-full mt-6 flex flex-row md:flex-row items-center md:justify-around justify-between">
                          <Button
                            type="submit"
                            className="bg-gray-500 hover:bg-gray-700 text-white font-bold md:py-2 md:px-4 rounded"
                          >
                            Confirmar
                          </Button>
                          <Button
...
export const getServerSideProps: GetServerSideProps = async (context) => {
  ...
  const correctUser = await verifyUserProfile(
