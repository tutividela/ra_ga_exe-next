...
const setup = async () => {
  await prisma.tipoPrenda.createMany({
    data: [
      {
        name: "Pantalón",
        picture: "https://cdn-icons-png.flaticon.com/512/2122/2122621.png",
      },
      {
        name: "Remera / Camiseta",
        picture: "https://cdn-icons-png.flaticon.com/512/2357/2357127.png",
      },
    ],
  });
  ...
  await prisma.complejidadConfeccion.createMany({
    data: [
      ...
      { name: "Ultra Complejo", description: "Ultra Complejo" },
      {
        ...
        description: "Extremadamente complejo",
      },
    ],
  });
