...
export type ExtendedOrdenData = Orden & {
  ...
  procesos: { estado: string, idEstado: number, proceso: string, idProceso: number, icon: string, id: string, lastUpdated: Date ,ficha: FichaTecnica & { archivos: ArchivoFichaTecnica[]; contenido: ContenidoFichaTencica; }, recursos: { key: string, text: string }[] }[]
  servicios: Servicio[]
};
