...
const ServiceUploadDialog = ({ process, open, onClose, orderData }: Props) => {
  ...
  const { mutateAsync: updateFicha } = useMutation<
    FichaTecnica,
    any,
    { data: ValidatedFichaTecnicaFileUploadSchema; fichaID: string }
  >(updateFichaFiles, {
  ...
  const handleUploadFile = async (
    file: {
      file: File;
      section: Paths<ValidatedFichaTecnicaFileUploadSchema>;
    }[]
  ) => {
