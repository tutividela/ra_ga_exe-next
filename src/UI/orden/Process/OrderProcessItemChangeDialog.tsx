...
const OrderProcessItemChangeDialog = (props: Props) => {
    ...
    const { data: estadosProcesoDesarrollo } = useQuery(['processStates'], fetchProcessStates, {
        initialData: [],
    ...
    const states = estadosProcesoDesarrollo.map((estadoProcesoDesarrollo) => ({ key: estadoProcesoDesarrollo.descripcion, text: estadoProcesoDesarrollo.descripcion }));
    function sePuedeHabilitarCambioEstado(estadoProcesoDesarrolloActual: string): boolean {
