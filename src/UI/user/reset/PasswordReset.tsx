...
} from "@backend/schemas/PasswordUpdateSchema";
...
const PasswordReset = (props: PasswordResetProps) => {
  ...
  >(updatePasssword, {
    onSuccess: () => {
      addError("Clave cambiada exitosamente", "success");
    },
  });
      ...
      <div className="flex md:flex-row flex-col md:justify-center md:space-x-10 mt-10">
        <LoadingIndicator show={isLoading}>
          <HookForm
            ...
            formOptions={{ resolver: zodResolver(PasswordUpdateSchema) }}
                ...
                <div className="w-auto">
                  <div className="flex flex-col justify-center items-center">
                    <div className="mt-6  mx-4">
                      <DoneIcon
                        className="text-green-500 rounded-full border-4 border-green-500"
