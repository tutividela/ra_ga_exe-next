...
const DashboardAdmin = () => {
  const sections = [
    ...
    {
      title: "Usuarios",
      description: "Acceso a manejo de usuarios",
      Icon: PeopleIcon,
      href: "/usuarios",
    },
    {
  ...
  return (
    <div className="md:mt-4 flex flex-col md:mx-10 lg:mx-0">
      ...
      <div
        className={`flex flex-col justify-evenly transition-all duration-200 md:mt-32`}
      >
        <div className="flex flex-wrap my-8 -m-4 justify-evenly">
          {sections.map((section, i) => (
            <LinkCard
              customSize="w-60 h-80 md:w-80 md:h-80 m-2"
              {...section}
              key={i}
            />
          ))}
