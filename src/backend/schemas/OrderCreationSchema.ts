...
export const OrderCreationDataSchema = z.object({
  ...
  tipoPrenda: z.object({
    ...
    name: z
      .string()
      .min(1, { message: "El nombre de la prenda no puede estar vacío" }),
...
export type OrderCreationData = ValidatedOrderSchema & {
  files: { file: File; section: Paths<ValidatedOrderSchema> }[];
};
